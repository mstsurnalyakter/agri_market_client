...
//   };
  ...
  return (
//     <div className='flex bg-teal-600 items-center justify-between p-6'>
//     <h6>Next <span>App</span></h6>
//     <ul className='flex items-center justify-center gap-6'>
//        {
//         links.map(link=><Link className={`${pathName===link.path ? "text-teal-700 underline" : "text-indigo-100"} font-bold text-lg`} href={link.path} key={link.path}>{link.title}</Link>)
...
// </div>
    ...
    <div className="shadow-lg bg-[#6EB092] sticky top-0 z-50 dark:bg-slate-900 duration-100">
      <Navbar className="mx-auto max-w-7xl bg-[#6EB092]  shadow-none rounded-none px-3 lg:px-2 pt-4  mb-6 lg:py-5">
